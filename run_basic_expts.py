...
task_list = [{"task_id":'DE1', "n_out":1, "n_loc":1, "out_nonlin":'sigmoid'},
             {"task_id":'DE2', "n_out":2, "n_loc":2, "out_nonlin":'sigmoid'},
...
torch.save({'all_params_list':model.state_dict(),
             ...
             'infloss_vec':np.asarray(infloss_vec)}, 'basic_sigma%f_lambda%f_rho%f_model%i_task%i.pt'%(offdiag_val, diag_val, wdecay_coeff, m_ind, t_ind))